 ...
 */
class tx_pitgooglemaps_pi1_wizicon {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pit_googlemaps/pi1/class.tx_pitgooglemaps_pi1_wizicon.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pit_googlemaps/pi1/class.tx_pitgooglemaps_pi1_wizicon.php']);
}
